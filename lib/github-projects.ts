...
export const mcpProjects: GitHubProject[] = [
  ...
  // ===== SRE/On-call/可观测性 增量（2026-07-25 补充） =====
  {
    ...
    description: "PagerDuty's official Model Context Protocol (MCP) server. Lets AI agents interact with PagerDuty incident and on-call data: list/acknowledge/resolve incidents, manage services, view schedules.",
    stars: 0, language: "TypeScript",
    topics: ["mcp","pagerduty","incident-response","oncall","sre"],
    defaultBranch: "main", readmePath: "README.md", area: "incident",
  ...
  },
  {
    ...
    owner: "incident-io", repo: "mcp",
    url: "https://github.com/incident-io/mcp",
    description: "The official incident.io MCP server. Provides tools for managing incidents, following along with the incident channel, and Catalog entries.",
    stars: 0, language: "Go",
    topics: ["mcp","incident-management","incident-response","status-page","oncall","sre"],
    defaultBranch: "main", readmePath: "README.md", area: "incident",
  ...
  {
    slug: "slack-mcp", kind: "mcp", name: "Slack MCP",
    owner: "modelcontextprotocol", repo: "servers",
    url: "https://github.com/modelcontextprotocol/servers/tree/main/src/slack",
    description: "MCP server for Slack — list channels, post messages, reply to threads, search messages, get user info. The official reference MCP server from Model Context Protocol org.",
    stars: 0, language: "TypeScript",
    topics: ["mcp","slack","messaging","collaboration","incident-communication"],
    defaultBranch: "main", readmePath: "src/slack/README.md", area: "incident",
  ...
  },
  {
    ...
    description: "MCP server for Grafana. Query dashboards, list datasources, search/inspect panels, run PromQL/Loki queries — turns Grafana into a tool the LLM can drive.",
    stars: 0, language: "Go",
    topics: ["mcp","grafana","prometheus","loki","observability","dashboard","sre"],
    defaultBranch: "main", readmePath: "README.md", area: "defense",
  ...
  },
  {
    ...
    owner: "Flux159", repo: "mcp-server-kubernetes",
    url: "https://github.com/Flux159/mcp-server-kubernetes",
    description: "MCP server for Kubernetes — list/get pods, services, deployments, namespaces, logs, and exec into pods. Bridges kubectl into the LLM.",
    stars: 0, language: "TypeScript",
    topics: ["mcp","kubernetes","kubectl","k8s","devops","sre","incident-response"],
    defaultBranch: "main", readmePath: "README.md", area: "defense",
...
export const skillProjects: GitHubProject[] = [
  ...
  },
  {
    ...
    stars: 80228, language: "JavaScript",
  ...
  },
  {
    ...
    stars: 2814, language: "TypeScript",
  ...
  },
  {
    ...
    stars: 1070, language: "JavaScript",
...
export const networkProjects: GitHubProject[] = [
  ...
  // ---- Agent ----
  {
    ...
    description: "An improved multi-agent AIOps and RAG platform for OnCall troubleshooting, featuring LangGraph-based diagnosis workflows, Milvus vector search, MCP tool integration, Prometheus alert knowledge from awesome-prometheus-alerts, and sanitized configuration for safe public deployment.",
  ...
  },
  {
    ...
    topics: ["agents","ai","anthropic","devops","fastapi","incident-response","langgraph","observability","on-call","pydantic-ai","python","sre"],
