...
export const mcpProjects: GitHubProject[] = [
  ...
  },
  {
    ...
    description: "The official incident.io MCP server (Golang reference implementation). Provides tools for managing incidents, following along with the incident channel, and Catalog entries.",
  ...
  },
  {
    ...
    description: "The most powerful MCP Slack Server with no permissions — list channels, post messages, reply to threads, search messages, get user info. Works without admin scopes; the de-facto reference for incident-channel bridges.",
  ...
  },
  {
    ...
    description: "Official CNCF / containers project MCP server for Kubernetes — list/get pods, services, deployments, namespaces, logs, and exec into pods. Bridges kubectl into the LLM.",
...
export const skillProjects: GitHubProject[] = [
  ...
  },
  {
    ...
    stars: 80308, language: "JavaScript",
  ...
  },
  {
    ...
    stars: 2817, language: "TypeScript",
